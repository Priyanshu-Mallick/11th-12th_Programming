 ...
 * @author hp
 */
public class Calcucator extends javax.swing.JFrame {

    /**
     * Creates new form Calucator
     */
    public Calcucator() {
        initComponents();
         setIconImage();
...
static float a,b,c,d=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 140, 30));
 ...
 String  te=jLabel3.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calcucator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calcucator().setVisible(true);
            }
        });
    }
    ...
    private int StringValueOf(int i) {
