 ...
 * @author hp
 */
public class Click2 extends javax.swing.JFrame {

    /**
     * Creates new form Click2
     */
    public Click2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Click2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
