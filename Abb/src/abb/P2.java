    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a=Integer.parseInt(jTextField1.getText());
          try{    
              ...
              Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/Abbr","root","Dipti077");
               Statement st=con.createStatement();
                ResultSet rs=st.executeQuery("select score from score");
               while(rs.next())
               {
                   jTextField2.setText(rs.getString("select score from score"));
               }
               rs.close();
               st.close();
               con.close();
       ...
       b=Integer.parseInt(jTextField2.getText());
          c=a+b;
          JOptionPane.showMessageDialog(null, "Your score is"+c);
